    ...
    userData && (
      <div className="flex flex-col max-w-lg gap-2 text-sm">
        ...
        <div>
          ...
          <div className="grid mt-3 text-neutral-700 grid-cols-[1fr_3fr] gap-y-2.5">
            <p className="font-medium">Email id:</p>
            <p className="text-blue-500">richardjameswap@gmail.com</p>
        ...
        <div>
          ...
          <div className="mt-10">
            {isEdit ? (
              <button
                className="px-8 py-2 transition-all border rounded-full hover:text-white border-primary hover:bg-primary"
