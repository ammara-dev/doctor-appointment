    ...
    <div>
      <div className="pt-10 text-2xl text-center text-gray-500">
        ...
        <div className="flex flex-col justify-center gap-10 my-10 text-sm mb-28 md:flex-row">
          ...
          <div className="flex flex-col gap-6 justify-content item-start">
...
Suite 350, Washington, USA</p>
            ...
            <p className="text-xl font-semibold text-gray-700">Careers at MEDIHELP</p>
            <p className="text-gray-500">Learn more about our teams and job openings.</p>
            <button className="px-8 py-4 text-sm transition-all duration-500 border border-black hover:bg-primary hover:text-white">Explore Jobs</button>
          </div>
        </div>
    </div>
  )
