...
const updateProfile = async() => {
  ...
  return profileData &&  (
    <div>
      ...
      <p className='mt-4 font-medium text-gray-600'>Appointment fee: <span className='text-gray-800'>{currency}{isEdit ? <input type="number"  onChange={(e) => setProfileData(prev => ({...prev, fees : e.target.value}))} value={profileData.fees }/> : profileData.fees}</span></p>
